...
sidenav: true
anchors:
 - name: What is the Opportunity Project (TOP)?
 - name: COVID-19 Diagnostics Design-a-thon
---

# COVID-19 Data-Driven Innovation

_Note: Please visit the [CDC’s website on COVID-19](https://www.cdc.gov/coronavirus/2019-ncov/index.html) for the most up-to-date information and guidance._

COVID-19 Data Driven Innovation uses novel methods and collaboration to accelerate scientific and public health insights to shorten the time it takes for COVID-19 information and solutions to save lives.

This HHS initiative is led by the [Office of the Assistant Secretary for Health](https://www.hhs.gov/ash/index.html) and the Office of the Chief Data Officer. Collaboratively, we are creating crosscutting impact and real-world value from a data-driven ecosystem during one of the most challenging public health crises of our lifetimes. Opening COVID-19 datasets on HealthData.gov and applying proven innovation methods like Health+ (“health plus”) allow COVID-19 innovation success to be measured by patient outcomes, social equity, economic recovery, and how HHS improved the lives of all Americans affected by novel coronavirus.
...
- COVID-19 At-Anywhere Diagnostics “Design-a thon” - A virtual innovation sprint with 750 problem solvers who produced over 30 capstone projects. [Winning Design-a-thon teams](https://www.hhs.gov/about/news/2020/12/16/winners-of-hhs-design-a-thon-to-develop-innovative-digital-health-tools-for-covid-19.html) captured COVID-19 diagnostic data and report key elements to inform a data-driven pandemic response.
- COVID-19 TOPx Technology Sprint – A fast-paced, 10-week build cycle using the “TOPx Toolkit” created by the U.S. Census Bureau with 12 industry-led teams to further develop COVID-19 diagnostic reporting tools and accelerate the public use of these tools, making it easier for individuals and organizations to safely report positive/negative test results.
- COVID-19 Open Data Roundtables – Hands on, structured workshops that improve accessibility and data sharing for public health and the public good, bringing together community, state and federal government leaders, the private sector, non-profits, research, and academia.
...
- [The Opportunity Project](https://opportunity.census.gov/) is a collaboration process developed by the White House in 2016 to speed up innovation fueled by government open data. Since then, the U.S. Census Bureau has scaled the program to different government agencies, working with thousands of participants to create over 100 digital products. TOP is a proven innovation model, typically a 12- to 14-week technology sprint with industry, which the government can leverage alongside open data to catalyze new technologies.
...
COVID-19 TOPx Tech Sprint Begins with Design-a-thon Teams — Join us! – Blog to launch the “COVID-19 TOPx” technology sprint to continue momentum and further develop digital health tools to capture, harmonize, and securely transmit key data elements from at-anywhere COVID-19 diagnostic tests.
...
_Note: Please visit the [CDC’s website on COVID-19](https://www.cdc.gov/coronavirus/2019-ncov/index.html) for the most up-to-date information and COVID-19 guidance._
...
_What are outcomes of the COVID-19 At-Anywhere Diagnostics Design-a-thon?_
...
A key function of WATERS is “optionality” – the ability to support disparate, complex systems to accommodate current and changing needs. We are ensuring that hospitals, nursing homes, and other healthcare providers have the options to use apps that suit their specific needs and reporting requirements. Such optionality will alleviate data collection and reporting burdens for patients, providers, anyone administering/using tests, labs through which data is routed, since the users can continue using their preferred app(s) and tool(s) for WATERS to ingest. Visit [Waters.Crowdicity.com –](https://waters.crowdicity.com/) to learn more about the COVID-19 At-Anywhere Design-a-thon along with upcoming events.
...
- [Roundtable on Data Sharing Policies, Data-Driven Solutions, and the Opioid Crisis July](http://reports.opendataenterprise.org/HHS-Opioid-Roundtable-Report.pdf) 2018

- [Lyme Innovation Roundtable December](http://reports.opendataenterprise.org/Lyme%20Innovation%20Roundtable%20Report.pdf) 2018

- [Roundtable on Sharing and Utilizing Health Data for AI Applications](https://healthdatasharing.org/wp-content/uploads/2020/07/RT1-AI-Summary-Report-FINAL-2020.07.28.pdf) April 2019

- [Roundtable on Balancing Privacy with Health Data Access](https://healthdatasharing.org/wp-content/uploads/2020/07/RT2-Privacy-Summary-Report-FINAL-2020.07.28.pdf) July 2019

- [Roundtable on Leveraging Data on the Social Determinants of Health](https://healthdatasharing.org/wp-content/uploads/2020/07/RT3-SDOH-Summary-Report-FINAL-2020.07.28.pdf) October 2019

- [Roundtable on Leveraging Data to Address Sickle Cell Disease](http://reports.opendataenterprise.org/SCD-Report-FINAL.pdf) June 2020

- [Roundtable on Using SDOH Data to Fight COVID-19 and Support Recovery Efforts](https://healthdatasharing.org/wp-content/uploads/2020/12/COVID-SDOH-Summary-Report-Final.pdf) August 2020
